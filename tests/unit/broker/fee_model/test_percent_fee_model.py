...
from datainvestor.broker.fee_model.percent_fee_model import PercentFeeModel
...
def test_percent_commission(
    ...
    """
    Verifica che ogni metodo restituisca l'appropriata
    percentuale di imposta/commissione
    """
